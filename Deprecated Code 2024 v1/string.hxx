...
By default, the string will be aligned to the hardware-specific SIMD Alignment requirements.
*/
...
private:
    FE::trackable<FE::unique_ptr<value_type[], Allocator>> m_smart_string;
...
public:
    ...
    _FE_CONSTEXPR20_ basic_string(const size_type count_p, const value_type value_p = null) noexcept
    {
        ...
        this->m_smart_string = FE::make_unique<value_type[], Allocator>(count_p + _NULL_ESCAPE_SIZE_);
