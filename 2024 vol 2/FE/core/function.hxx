...
public:
    ...
    _CONSTEXPR20_ _FORCE_INLINE_ function(function_type function_p) noexcept : m_function_pointer(function_p) {}
    _CONSTEXPR20_ _FORCE_INLINE_ explicit function(const function& other_p) noexcept : m_function_pointer(other_p.m_function_pointer) {}
    _CONSTEXPR20_ _FORCE_INLINE_ explicit function(function&& rvalue_p) noexcept : m_function_pointer(rvalue_p.m_function_pointer) { rvalue_p.m_function_pointer = nullptr; }
