...
protected:
	...
	_CONSTEXPR_ _FORCE_INLINE_ optional_base() noexcept : m_is_constructed() {}
	_CONSTEXPR_ _FORCE_INLINE_ optional_base(boolean is_constructed_p) noexcept : m_is_constructed(is_constructed_p) {}
	_CONSTEXPR_ _FORCE_INLINE_ ~optional_base() noexcept {}

public:
	template<typename T, FE::TYPE_TRIVIALITY object_triviality = FE::is_trivially_constructible_and_destructible<T>::value>
	_FORCE_INLINE_ void swap(optional<T, object_triviality>& left_p, optional<T, object_triviality>& right_p)
	{
...
public:
	...
	_CONSTEXPR_ _FORCE_INLINE_ optional() noexcept : base(), m_memory(), m_memory_ptrc(reinterpret_cast<T*>(m_memory)) {}
	_CONSTEXPR_ _FORCE_INLINE_ optional(_MAYBE_UNUSED_ nullopt_t nullopt_p) noexcept : base(false), m_memory(), m_memory_ptrc(reinterpret_cast<T*>(m_memory)) {}
...
public:
	...
	_CONSTEXPR_ _FORCE_INLINE_ optional() noexcept : base(), m_plain_old_data() {}
	_CONSTEXPR_ _FORCE_INLINE_ optional(_MAYBE_UNUSED_ nullopt_t nullopt_p) noexcept : base(false), m_plain_old_data() {}
