...
struct task_base
{
    _NODISCARD_ virtual RETURN_TYPE execute(_MAYBE_UNUSED_ void* out_return_ptr_p = nullptr) noexcept = 0;
};
...
struct void_function : public task_base
{
    ...
    _NODISCARD_ virtual RETURN_TYPE execute(_MAYBE_UNUSED_ void* out_return_ptr_p = nullptr) noexcept override
    {
        _function();
...
struct function : public task_base
{
    ...
    _NODISCARD_ virtual RETURN_TYPE execute(void* out_return_ptr_p) noexcept override
    {
