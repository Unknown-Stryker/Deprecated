...
// Do not put namespaces in front of a class name, nor put this macro inside any namespaces.
#define ALLOW_ITS_FRIEND_TESTING(test_subject_class_name_p) friend class sample_##test_subject_class_name_p##_instance_Test

// Do not put namespaces in front of a class name, nor put this macro inside any namespaces.
#define TEST_FROGMAN_API(test_subject_class_name_p, test_case_p) TEST_F(sample_##test_subject_class_name_p, test_case_p)
