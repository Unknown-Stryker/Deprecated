...
def initialize():
    ...
    print("- Welcome to Frogman API Memory Utilization Analyzer - version: 2023.05.16 release build\n\n")
...
def find_csv(filename_p):
    ...
    if  filename_p.endswith('.csv'):
        ...
        plt.ylabel('Frogman API Memory Utilization In Bytes')
        plt.title(f"Frogman API Memory Utilization Graph: {filename_p}")
