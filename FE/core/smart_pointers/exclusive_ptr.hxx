...
_CONSTEXPR23_ _NODISCARD_ exclusive_ptr<T, Allocator> make_owner() noexcept
{
...
template<typename T, class Allocator = FE::new_delete_allocator<FE::aligned_allocator<T>>>
_CONSTEXPR23_ _NODISCARD_ exclusive_ptr<T, Allocator> make_owner(T value_p) noexcept
{
	static_assert(std::is_array<T>::value == false, "static assertion failed: The typename T must not be an array type");
...
template<typename T, class Allocator = FE::new_delete_allocator<FE::aligned_allocator<typename std::remove_all_extents<T>::type>>>
_CONSTEXPR23_ _NODISCARD_ exclusive_ptr<typename std::remove_all_extents<T>::type[], Allocator> make_owner(size_t array_size_p) noexcept
{
...
template<typename T, class Allocator = FE::new_delete_allocator<FE::aligned_allocator<typename std::remove_all_extents<T>::type>>>
_CONSTEXPR23_ _NODISCARD_ exclusive_ptr<typename std::remove_all_extents<T>::type[], Allocator> make_owner(std::initializer_list<typename std::remove_all_extents<T>::type>&& values_p) noexcept
{
	static_assert(std::is_array<T>::value == true, "static assertion failed: The typename T must be an array type");
